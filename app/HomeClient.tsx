        ...
        <div className="mx-auto max-w-4xl px-6 sm:px-8">
          ...
          >
            <motion.div variants={fadeInUp} className="mb-12 text-center">
              <p className="mb-4 font-display text-sm tracking-[0.3em] text-[#6b8e6f]">
                CONTACTEZ NOUS
              </p>
              <h2 className="mb-8 font-display text-4xl tracking-tight text-[#f5f3f0] sm:text-5xl lg:text-6xl">
                Prêt à discuter de votre projet ?
              </h2>
              <p className="mx-auto max-w-2xl text-lg leading-relaxed text-[#f5f3f0]/70">
